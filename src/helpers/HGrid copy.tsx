...
// Type de colonne issue de Grid
type HGridColumnElement = ReactElement<GridColumnProps, typeof GridColumn>;
...
/**
 * Cas 1 : children explicitement donnés
 */
interface WrapperWithChildren<T, K extends keyof T> extends IHGridOwnProps<T, K> {
  children: HGridColumnElement | HGridColumnElement[];
  hColumnsProps?: never;
}

/**
 * Cas 2 : pas de children → colonnes via props
 */
interface WrapperWithHColumns<T, K extends keyof T> extends IHGridOwnProps<T, K> {
  children?: undefined;
  hColumnsProps: GridColumnProps[];
}

type HGridOwnProps<T, K extends keyof T> = WrapperWithChildren<T, K> | WrapperWithHColumns<T, K>;
